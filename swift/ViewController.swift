...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let settingsViews: [UIView] = [setDestinationButton, routeUILabel, routeUISwitch, routePointsLabel, routePointsSwitch, barometrLabel]
        ...
        [routeUILabel, routePointsLabel, barometrLabel].forEach {
    ...
    var barometrLabel: UILabel = UILabel()
